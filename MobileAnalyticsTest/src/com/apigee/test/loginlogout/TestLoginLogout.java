...
/*
 * Purpose: the driver program to start log in and log out testing
 * Author: Tom Lee
 * @Apigee Corporation
 */
public class TestLoginLogout extends BasedBrowser {
	...
	@Test(enabled=true)
	public void testLoginLogout(String baseurl, String screenshotdir, String testdataDir) throws IOException {
