...
/*
 * Purpose: a list of common methods shared by other
 * Author: Tom Lee
 * @Apigee Corporation
 */
public class Util extends BasedBrowser {
	...
	private static File objectXml=new File("/Users/ApigeeCorporation/Automation/EclipseWorkspace/MobileAnalyticsTest/testdata/objectPath.xml");
