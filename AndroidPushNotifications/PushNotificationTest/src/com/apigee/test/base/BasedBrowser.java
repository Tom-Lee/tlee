...
/**
 * This class is to define the Selenium server operation
 * Author: tlee
 */
public class BasedBrowser extends TestCase{
	...
	protected void init(@Optional("localhost")String server, @Optional("90")int port, @Optional("*firefox")String br, @Optional("http://www.apigee.com")String appurl) throws Exception {
		//protected void init(@Optional("localhost")String server, @Optional("90")int port, @Optional("*googlechrome")String br, @Optional("http://www.apigee.com")String appurl) throws Exception {	
